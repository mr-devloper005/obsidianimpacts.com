            ...
            <div className="grid gap-8 lg:grid-cols-[1fr_1fr] lg:items-start">
              ...
              <div className="rounded-[2rem] border border-[rgba(45,56,87,0.12)] bg-[linear-gradient(180deg,rgba(255,255,255,0.92),rgba(247,241,232,0.96))] p-7 shadow-[0_24px_80px_rgba(47,35,26,0.08)]">
                ...
                <form className="mt-6 grid gap-4">
                  <input className="h-12 rounded-xl border border-[rgba(45,56,87,0.12)] bg-white/70 px-4 text-sm" placeholder="Your name" />
                  <input className="h-12 rounded-xl border border-[rgba(45,56,87,0.12)] bg-white/70 px-4 text-sm" placeholder="Email address" />
                  <input className="h-12 rounded-xl border border-[rgba(45,56,87,0.12)] bg-white/70 px-4 text-sm" placeholder="What are you reaching out about?" />
                  <textarea className="min-h-[180px] rounded-2xl border border-[rgba(45,56,87,0.12)] bg-white/70 px-4 py-3 text-sm" placeholder="Share the full context so the right editorial or support lane can respond." />
                  <button type="submit" className="inline-flex h-12 items-center justify-center rounded-full bg-[#19294a] px-6 text-sm font-semibold text-white hover:bg-[#24375f]">
                    Send message
                  </button>
                </form>
              </div>

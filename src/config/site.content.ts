...
export const siteContent = {
  ...
  hero: {
    badge: 'Bold editorial coverage',
    title: ['Browse high-contrast article blocks, analysis, and story-driven publishing.'],
    description:
      'A contrast-rich editorial publication designed for article discovery, analysis, and premium content browsing.',
    primaryCta: {
      label: 'View articles',
      href: '/articles',
    },
